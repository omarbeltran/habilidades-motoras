...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post progresses_url, params: { progress: { Publication_id: @progress.Publication_id, User_id: @progress.User_id } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { Publication_id: @progress.Publication_id, User_id: @progress.User_id } }
